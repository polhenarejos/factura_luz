...
def es_festivo(date):
    festivos = ['1/1/21','6/1/21','2/4/21','1/5/21','12/10/21','1/11/21','6/12/21','8/12/21','25/12/21',
                '1/1/22','6/1/22','15/4/22','15/8/22','12/10/22','1/11/22','6/12/22','8/12/22',
                '6/1/23','7/4/23','1/5/23','15/08/23', '12/10/23','1/11/23','6/12/23','8/12/23','25/12/23'
                ]
...
def parse_csv(args):
    ...
    with open(args.file) as f:
        ...
        if (P2['kwh']):
            print('\t\tP2 (Llano): {} kWh ({}%)'.format(round(P2['kwh'],2),round(P2['kwh']/total_kwh*100,2)))
        if (P3['kwh']):
            print('\t\tP3 (Valle): {} kWh ({}%)'.format(round(P3['kwh'],2),round(P3['kwh']/total_kwh*100,2)))
